; Script for program NETWORK in file "M:\Projects\BLW I-4 impacts ELToDv2.3 2017\APP\00NET00O.S"
...
MERGE RECORD=FALSE
V_HR1_SOV = LI.1.V1_2 + LI.1.V2_2 + LI.1.V3_2 
V_HR1_HOV = LI.1.V4_2 + LI.1.V5_2 + LI.1.V6_2
V_HR1_TRK = LI.1.V7_2 + LI.1.V8_2

V_HR2_SOV = LI.2.V1_2 + LI.2.V2_2 + LI.2.V3_2 
V_HR2_HOV = LI.2.V4_2 + LI.2.V5_2 + LI.2.V6_2
V_HR2_TRK = LI.2.V7_2 + LI.2.V8_2

V_HR3_SOV = LI.3.V1_2 + LI.3.V2_2 + LI.3.V3_2 
V_HR3_HOV = LI.3.V4_2 + LI.3.V5_2 + LI.3.V6_2
V_HR3_TRK = LI.3.V7_2 + LI.3.V8_2

V_HR4_SOV = LI.4.V1_2 + LI.4.V2_2 + LI.4.V3_2 
V_HR4_HOV = LI.4.V4_2 + LI.4.V5_2 + LI.4.V6_2
V_HR4_TRK = LI.4.V7_2 + LI.4.V8_2

V_HR5_SOV = LI.5.V1_2 + LI.5.V2_2 + LI.5.V3_2 
V_HR5_HOV = LI.5.V4_2 + LI.5.V5_2 + LI.5.V6_2
V_HR5_TRK = LI.5.V7_2 + LI.5.V8_2

V_HR6_SOV = LI.6.V1_2 + LI.6.V2_2 + LI.6.V3_2 
V_HR6_HOV = LI.6.V4_2 + LI.6.V5_2 + LI.6.V6_2
V_HR6_TRK = LI.6.V7_2 + LI.6.V8_2

V_HR7_SOV = LI.7.V1_2 + LI.7.V2_2 + LI.7.V3_2 
V_HR7_HOV = LI.7.V4_2 + LI.7.V5_2 + LI.7.V6_2
V_HR7_TRK = LI.7.V7_2 + LI.7.V8_2
...
; VC Ratio
VC_RATIO_HR1 = LI.1.VC_2
VC_RATIO_HR2 = LI.2.VC_2
VC_RATIO_HR3 = LI.3.VC_2
VC_RATIO_HR4 = LI.4.VC_2
VC_RATIO_HR5 = LI.5.VC_2
VC_RATIO_HR6 = LI.6.VC_2
VC_RATIO_HR7 = LI.7.VC_2

; Toll
TOLL_HR1 = LI.1.LW_TOLL_REV_2
TOLL_HR2 = LI.2.LW_TOLL_REV_2
TOLL_HR3 = LI.3.LW_TOLL_REV_2
TOLL_HR4 = LI.4.LW_TOLL_REV_2
TOLL_HR5 = LI.5.LW_TOLL_REV_2
TOLL_HR6 = LI.6.LW_TOLL_REV_2
TOLL_HR7 = LI.7.LW_TOLL_REV_2

; Congested Speed (CSPD)
CSPD_HR1 = LI.1.DISTANCE/LI.1.LW_CGTIME_2*60
CSPD_HR2 = LI.2.DISTANCE/LI.2.LW_CGTIME_2*60
CSPD_HR3 = LI.3.DISTANCE/LI.3.LW_CGTIME_2*60
CSPD_HR4 = LI.4.DISTANCE/LI.4.LW_CGTIME_2*60
CSPD_HR5 = LI.5.DISTANCE/LI.5.LW_CGTIME_2*60
CSPD_HR6 = LI.6.DISTANCE/LI.6.LW_CGTIME_2*60
CSPD_HR7 = LI.7.DISTANCE/LI.7.LW_CGTIME_2*60

;Time
TIME_HR1 = LI.1.LW_CGTIME_2
TIME_HR2 = LI.2.LW_CGTIME_2
TIME_HR3 = LI.3.LW_CGTIME_2
TIME_HR4 = LI.4.LW_CGTIME_2
TIME_HR5 = LI.5.LW_CGTIME_2
TIME_HR6 = LI.6.LW_CGTIME_2
TIME_HR7 = LI.7.LW_CGTIME_2
